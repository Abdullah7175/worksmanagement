...
const pool = new Pool({
  user: process.env.DB_USER || process.env.PG_USER || 'root',
  host: process.env.DB_HOST || process.env.PG_HOST || '103.65.248.160',
  database: process.env.DB_NAME || process.env.PG_DATABASE || 'warehouse',
  password: process.env.DB_PASSWORD || process.env.PG_PASSWORD || '**@/#Abc1',
